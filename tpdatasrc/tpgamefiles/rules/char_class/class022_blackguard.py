...
spell_list = {
	1: (spell_blade_of_blood, spell_blessed_aim, spell_faith_healing, spell_cause_fear, spell_cure_light_wounds, spell_doom, spell_inflict_light_wounds, spell_magic_weapon, spell_strategic_charge, spell_summon_monster_i, spell_summon_undead_i),
